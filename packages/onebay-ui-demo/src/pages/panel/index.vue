  ...
  <div class="page">
    <div class="panel-header">
      <div class="panel-header__icon">
        ...
        <span v-else class="ob-icon ob-icon-list" />
      </div>
    ...
    <div class="panel-body">
      <div class="component-list">
        ...
        >
          ...
          <span class="ob-icon ob-icon-chevron-right" />
        </div>
      </div>
    </div>
  </div>
...
<style lang="scss">
@import '../../../../onebay-ui/src/style/mixins/index.scss';

@import '../../../../onebay-ui/src/style/variables/default.scss';
@import './index.scss';
</style>