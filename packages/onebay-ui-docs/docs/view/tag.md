  ...
  <div class="page">
    ...
    <div class="doc-body">
      ...
      <div class="panel">
        ...
        <div class="panel__content">
          <div class="example-item">
            <div v-for="(item, index) in hollowTagList" class="subitem" :key="`ob-tag-${index}`">
              <Tag
                :name="item.name"
                :active="item.active"
                :circle="index % 2 === 0"
      ...
      <div class="panel">
        ...
        <div class="panel__content">
          <div class="example-item">
            <div v-for="(item, index) in solidTagList" class="subitem" :key="`ob-tag-${index}`">
              <Tag
                type="primary"
                :name="item.name"
                :active="item.active"
      ...
      <div class="panel">
        ...
        <div class="panel__content">
          <div class="example-item">
            <div v-for="(item, index) in tagList" class="subitem" :key="`ob-tag-${index}`">
              <Tag
                :name="item.name"
                type="primary"
                :active="item.active"
      ...
      <div class="panel">
        ...
        <div class="panel__content">
          <div class="example-item">
            <div v-for="(item, index) in hollowTagList2" class="subitem" :key="`ob-tag-${index}`">
              <Tag
                size="small"
                :name="item.name"
                :active="item.active"
      ...
      <div class="panel">
        ...
        <div class="panel__content">
          <div class="example-item">
            <div v-for="(item, index) in solidTagList2" class="subitem" :key="`ob-tag-${index}`">
              <Tag
                size="small"
                type="primary"
                :name="item.name"
