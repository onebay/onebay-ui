      ...
      <div class={rootCls} style={customStyle} ref="root">
        <div class="ob-search-bar__input-cnt">
          <div class="ob-search-bar__placeholder-wrap" style={placeholderWrapStyle}>
            ...
            <div class="ob-search-bar__placeholder" style={placeholderStyle}>
              {isFocus ? '' : placeholder}
            </div>
          </div>
          <input
            class="ob-search-bar__input"
            type={inputType}
            value={value}
            disabled={disabled}
            maxlength={maxLength}
            ...
            onBlur={handleBlur}
          />
          <div class="ob-search-bar__clear" style={clearIconStyle} onClick={handleClear}>
            <div class="ob-icon ob-icon-close-circle"></div>
          </div>
        </div>
        <div
          class="ob-search-bar__action"
          style={actionStyle}
