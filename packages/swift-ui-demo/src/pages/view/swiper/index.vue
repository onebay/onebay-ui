<template>
  <div id="vueSwiper" class="demo-list">
    ...
    <at-swiper :paginationVisibile="true" direction="horizontal" :swiperData="dataImgItem">
      <div v-for="(item, index) in dataImgItem" :key="index" class="at-swiper-slide">
...
import { Swiper } from '/@/swift-ui/src/index.ts'
...
#vueSwiper {
  ...
  // .at-swiper-slide:nth-child(1), .at-swiper-slide:nth-child(3){
  //     color:#fff;
  //     background:#848689;
  // }
  // .at-swiper-slide:nth-child(2), .at-swiper-slide:nth-child(4){
  //     color:#333;
  //     background:#ccc;
  // }
}
