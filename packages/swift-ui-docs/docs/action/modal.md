...
import { Button, Modal, ModalAction, ModalHeader, ModalContent } from 'swift-ui/src/index'
import toast from 'swift-ui/src/plugins/toast'
import modal from 'swift-ui/src/plugins/modal'
...
<script>
import { defineComponent } from 'vue'
import { Button, Modal, ModalAction, ModalHeader, ModalContent } from '/@/swift-ui/src/index.ts'
export default defineComponent({
  components: {
    Button,
    Modal,
