...
const Range = defineComponent({
  ...
  methods: {
    ...
    updatePos(): void {
      const rect = this.$el.querySelector('.at-range__container')
  ...
  render() {
    ...
    return (
      <div class={rootCls} style={customStyle} onClick={handleClick}>
        <div class="at-range__container" style={containerStyle}>
          <div class="at-range__rail" style={railStyle}></div>
          <div class="at-range__track" style={mergeStyle(atTrackStyle, trackStyle)}></div>
          <div
